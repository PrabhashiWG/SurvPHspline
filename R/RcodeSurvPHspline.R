...
#'
#' The package provides statistical methods for conducting regression analysis of arbitrarily censored data that are potentially subject to left truncation under the PH model with monotone splines.
...
#' \emph{A flexible parametric approach for analyzing arbitrarily censored data that are potentially subject to left truncation under the proportional hazards model}.
#' Submitted.
#' }
#' @importFrom Rdpack reprompt
#' @export

SurvPHspline.EM<-function(d1, d2, d3, Li, Ri,Ei, Xp, n.int, order, g0, b0, tol, t.seq, equal = FALSE){
